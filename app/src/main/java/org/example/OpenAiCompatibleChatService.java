...
7) コードやファイルを示すときは、ワークスペース相対パスと行範囲を明示すること（例: `src/main/java/org/example/App.java` の `L30-L60`）。
...
""";
    ...
    public OpenAiCompatibleChatService(
            ...
            WorkspaceGrepTool grepTool,
            GitLogTool gitTool,
            org.example.tools.FileReaderTool fileReaderTool) {
    ...
    public OpenAiCompatibleChatService(
            ...
            GitLogTool gitTool,
            org.example.tools.FileReaderTool fileReaderTool,
            org.example.tools.FileWriterTool fileWriterTool) {
    ...
    public void setWorkingDirectory(Path dir) {
        ...
        agentTools.updateFileToolReferences(
            new org.example.tools.FileReaderTool(normalized),
            new org.example.tools.FileWriterTool(normalized));
    }
